...
export const TableShowcase = () => {
  return (
    <div className="table-showcase stack gap-sm">
      ...
      <Paragraph>See how the following tables wrap on mobile.</Paragraph>
      <div className="stack gap-lg">
        <div className="table-showcase__example stack gap-sm">
          <Heading level={3}>Regular table</Heading>
          <Table>
            <Table.Header>
        ...
        <div className="table-showcase__example stack gap-sm">
          <Heading level={3}>Dark table</Heading>
          <Table isDarkTable>
            <Table.Header>
              <Table.Cell isHeader>Fruit</Table.Cell>
              <Table.Cell isHeader>Colour</Table.Cell>
